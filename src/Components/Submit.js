        ...
        return (
            ...
            <form role= 'form' name="articleform" onSubmit={(e) => this.handleSubmit(e)}>
                ...
                <div className="form-group">
                    ...
                    <button role= 'button' id="submitButton" type="submit" className="submit-button btn-default color" onClick={this.articleSubmit} disabled={!buttonEnabled}>Submit Article</button>
                </div>
            </form>
            </div>
        );
